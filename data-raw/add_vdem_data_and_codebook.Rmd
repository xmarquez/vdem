...
library(tidyverse)
path <- "./Country_Year_V-Dem_Full+others_R_v10/"
```
...
VDem_plus <- read_rds(paste0(path, "V-Dem-CY-Full+Others-v10.rds")) %>%
  as_tibble()
...
vdem_codebook_raw <- pdf_text(paste0(path,"V-Dem Codebook v10.pdf"))
...
vdem_codebook_raw_nopage <- vdem_codebook_raw[c(41:398)]

vdem_codebook_raw_nopage <- vdem_codebook_raw_nopage %>% 
  str_replace(paste0("\\r\\nTOC[ ]+", as.character(1:length(vdem_codebook_raw_nopage) + 39), "\\r\\n$"), "")
