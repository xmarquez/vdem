...
dataset, version
11.1](https://www.v-dem.net/en/data/data/v-dem-dataset-v111/). It
...
#>    vdem_country_name vdem_country_text~ vdem_country_id  year extended_country_~
#>    <chr>             <chr>                        <dbl> <dbl> <chr>             
...
vdem_codebook
#> # A tibble: 761 x 22
#>    section number name    label       type  project_manager    additional_versi~
#>      <int> <chr>  <chr>   <chr>       <chr> <chr>              <chr>            
#>  1       2 2.1.1  v2x_po~ Electoral ~ (D)   Jan Teorell        *_codelow, *_cod~
#>  2       2 2.1.2  v2x_li~ Liberal de~ (D)   Jan Teorell        *_codelow, *_cod~
#>  3       2 2.1.3  v2x_pa~ Participat~ (D)   Jan Teorell        *_codelow, *_cod~
#>  4       2 2.1.4  v2x_de~ Deliberati~ (D)   Jan Teorell        *_codelow, *_cod~
#>  5       2 2.1.5  v2x_eg~ Egalitaria~ (D)   Rachel Sigman, St~ *_codelow, *_cod~
#>  6       2 2.2.1  v2x_api Additive p~ (D)   Jan Teorell        *_codelow, *_cod~
#>  7       2 2.2.2  v2x_mpi Multiplica~ (D)   Jan Teorell        *_codelow, *_cod~
#>  8       2 2.2.3  v2x_fr~ Freedom of~ (D)   Svend-Erik Skaani~ *_codelow, *_cod~
#>  9       2 2.2.4  v2x_fr~ Freedom of~ (D)   Allen Hicken, Mic~ *_codelow, *_cod~
#> 10       2 2.2.5  v2x_su~ Share of p~ (D)   Svend-Erik Skaani~ <NA>             
#> # ... with 751 more rows, and 15 more variables: available_versions <chr>,
